...
response = requests.post(auth_url, headers=headers, auth=auth_data, verify=False)
...
post_response = requests.post(post_url, headers=headers, json=cli_commands, verify=False)
