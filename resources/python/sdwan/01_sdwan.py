...
auth_url = 'https://sandbox-sdwan-1.cisco.com/dataservice/j_security_check'
auth_data = {'j_username': 'devnetuser', 'j_password': 'RG!_Yw919_83'}
...
get_url = 'https://sandbox-sdwan-1.cisco.com/dataservice/template/device'
...
put_url = 'https://sandbox-sdwan-1.cisco.com/dataservice/settings/configuration/banner'
